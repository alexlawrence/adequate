...
const execTerser = options =>
  childProcess.execSync(`./node_modules/.bin/terser -cm -o ${options}`, {
    stdio: 'inherit',
  });
...
build('react@16.12.0', ['react.production.min.js', 'react-dom.production.min.js']);
build('preact@10.2.1', ['preact.umd.js', 'hooks.umd.js']);
